import { collection, query, where, onSnapshot, deleteDoc, doc, addDoc, updateDoc, serverTimestamp, type Unsubscribe } from 'firebase/firestore';
import { ref as storageRef, uploadBytesResumable, getDownloadURL } from 'firebase/storage';
import { db, storage } from '../firebase';
import type { Post } from '../types';

export const subscribeToUserPosts = (userId: string, callback: (posts: Post[]) => void): Unsubscribe => {
...
export const updateUserPost = (postId: string, postData: Partial<Post>): Promise<void> => {
